package com.example.administrator.accesswords21;
...
//得到按钮
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String word="Banana";//简单起见，这里指定ID，用户可在程序中设置id的实际值
                Uri uri = Uri.parse(Words.Word.CONTENT_URI_STRING );
                int result = resolver.delete(uri, Words.Word.COLUMN_NAME_WORD+"=?", new String[]{word});
            }
        });
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse(Words.Word.CONTENT_URI_STRING );
                int result = resolver.update(uri, values, Words.Word.COLUMN_NAME_WORD+"=?", new String[]{word});
